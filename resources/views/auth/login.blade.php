      ...
      <div class="row">
        ...
        <div class="col-md-6 contents">
          <div class="row justify-content-center  bg-info text-white">
            <div class="col-md-12">
              <div class="mb-4">
              <h3 class="text-center text-white">Indéntification</h3>
              <p class="mb-4  text-white " style="font-size: 24px;">Ordre des Professionnels Comptable du Burundi</p>
            </div>
            <form action="{{ route('login') }}" method="POST">
              ...
              <div class="d-flex mb-5 align-items-center">
                <label class="control control--checkbox mb-0"><span class="text-white">Se Souvenir de moi</span>
                  <input type="checkbox" checked="checked"/>
                  <div class="control__indicator"></div>
                </label>
                <span class="ml-auto text-white"><a href="#" class="forgot-pass text-white">Mot de passe oublié</a></span> 
              </div>
